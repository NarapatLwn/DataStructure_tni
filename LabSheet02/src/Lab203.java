...
public class Lab203 {
	...
	public static void main(String[] args) {
		...
		//1-สร้างฟังก์ชันเพิ่มขนาดอาเรย์อีก 1 ตำแหน่ง และคงข้อมูลไว้
	public static String[] addArraySize(String[] subjects){
		...
		//2-ลบข้อมูลในอาเรย์ ตามตำแหน่งที่ส่งมา
	...
	return newArray;
		...
		//3-อัพเดทข้อมูลในอาเรย์ตามตำแหน่งและข้อมูลที่ส่งมา และคืนค่าอาเรย์ที่อัปเดตเรียบร้อย
